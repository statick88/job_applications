...
with open("search_response.xml", "r", encoding="utf-8") as f:
...
payload = {
    ...
    "javax.faces.source": "formBuscaOferta:listResult:1:modalDialogButton", # Note the correct ID!
    "javax.faces.partial.execute": "formBuscaOferta:listResult:1:modalDialogButton",
    "javax.faces.partial.render": "formVerOferta",
    "formBuscaOferta:listResult:1:modalDialogButton": "formBuscaOferta:listResult:1:modalDialogButton",
    "formBuscaOferta": "formBuscaOferta",
    "formBuscaOferta:pagina_focus": "",
    "formBuscaOferta:pagina_input": "1",
    "javax.faces.ViewState": view_state
}

print("Posting view job request...")
response = requests.post(url, data=payload, cookies=cookies, headers=headers, timeout=20)
print("Status Code:", response.status_code)

with open("view_job_response.xml", "w", encoding="utf-8") as f:
